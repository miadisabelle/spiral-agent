...
export class ActionExecutor {
   ...
   */
  private async executeRead(filePath: string): Promise<ActionResult> {
    try {
   ...
   */
  private async executeCode(instruction: string): Promise<ActionResult> {
    try {
   ...
   */
  private async executeInfo(message: string): Promise<ActionResult> {
   ...
   */
  private async executeMemory(query: string): Promise<ActionResult> {
   ...
   */
  private executeFinish(message: string): ActionResult {
